...
#include "Questionable_030/Player/Questionable_030Character.h"
...
void ADirector::BeginPlay()
{
	...
	UGameplayStatics::GetAllActorsOfClass(GetWorld(), AQuestionable_030Character::StaticClass(), m_pTempArray);
