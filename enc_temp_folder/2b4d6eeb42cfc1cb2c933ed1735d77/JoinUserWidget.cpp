...
void UJoinUserWidget::SetSelectedClass(FName ClassKey)
{
	...
	FLinearColor DarkRed(0.141f, 0, 0, 1.f);
	...
	if (ClassKey == "Ares")
	{
		SetButtonColor(AresButton, DarkRed);
		SetBorderColor(B_Ares, Gold);
	}
	else if (ClassKey == "Artemis")
	{
		SetButtonColor(ArtemisButton, DarkRed);
		SetBorderColor(B_Artemis, Gold);
	}
	else if (ClassKey == "Aphrodite")
	{
		SetButtonColor(AphroditeButton, DarkRed);
		SetBorderColor(B_Aphrodite, Gold);
	}
	else if (ClassKey == "Nemesis")
	{
		SetButtonColor(NemesisButton, DarkRed);
		SetBorderColor(B_Nemesis, Gold);
	}
