...
void UInventoryToolTip::Setup(UItemObject* HoveredItem, const FLinearColor& HoveredColor, UItemObject* EquippedItem)
{
    ...
    TB_LevelTooltip->SetText(FText::FromString("Lv " + FString::FromInt(HoveredItem->GetLevel())));
    ...
    if (HasEquipped)
    {
        ...
        TB_LevelTooltip_1->SetText(FText::FromString("Lv " + FString::FromInt(EquippedItem->GetLevel())));
