...
#include "PlayerHUDWorld.generated.h"

UCLASS()
class RELICRUNNERS_API UPlayerHUDWorld : public UUserWidget
{
	GENERATED_BODY()

public:

	void InitWidgetWithCharacter(class ARelicRunnersCharacter* InOwnerCharacter);
